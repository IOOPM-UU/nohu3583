...
int main(void) {
    int i = ask_question_int("Mata in ett heltal:");
    double f = ask_question_float("Mata in ett flyttal:");
    char *s = ask_question_string("Mata in en sträng:");

    printf("Du matade in heltalet: %d\n", i);
    printf("Du matade in flyttalet: %f\n", f);
    printf("Du matade in strängen: %s\n", s);
